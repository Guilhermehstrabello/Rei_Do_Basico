  ...
  return (
    <section className="2xl:w-[calc(1640px+280px)] xl:w-[calc(1240px+280px)] 2xl:-ml-[260px] xl:-ml-[40px] flex flex-col bg-gradient-to-b from-[#08221F] via-[#082D22] to-[#08221F] gap-8 mb-24 mt-20">
      ...
      <div className={`overflow-hidden transition-all duration-500 ${openIndex === 0 ? 'max-h-[200px]' : 'max-h-0'}`}>
        {openIndex === 0 && (
          <p className="text-base mx-auto w-[540px] text-left text-white">Oferecer materiais de construção de alta qualidade e acessíveis para transformar projetos em realidade, garantindo praticidade, eficiência e excelência no atendimento, ajudando nossos clientes a construir seus sonhos com solidez e segurança.</p>
        )}
      </div>
      ...
      <div className={`overflow-hidden transition-all duration-500 ${openIndex === 1 ? 'max-h-[400px]' : 'max-h-0'}`}>
        {openIndex === 1 && (
          <p className="text-base mx-auto w-[780px] text-left text-white space-y-6">
      ...
      <div className={`overflow-hidden transition-all duration-500 ${openIndex === 2 ? 'max-h-[200px]' : 'max-h-0'}`}>
        {openIndex === 2 && (
          <p className="text-base mx-auto w-[720px] text-left text-white">Ser reconhecido como referência em materiais de construção, oferecendo bem mais do que o básico, tornando-se a primeira escolha de nossos clientes em toda a região. Buscamos trabalhar com foco 100% na qualidade, no atendimento de excelência e no desenvolvimento sustentável do setor de construção civil.</p>
        )}
      </div>
    </section>
  );
